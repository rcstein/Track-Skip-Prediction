...
glm_numeric = glm(formula,family = binomial(),data = train_numeric)
...
```{r}
X_lasso = model.matrix(formula, data = total_data)
...
f_cat =  paste(colnames(temp),ps,collapse = " + ",sep = '')
fla_cat = as.formula(paste(c('~ ',f_tot),collapse = '',sep=''))
#>>>>>>>>>>>>>
