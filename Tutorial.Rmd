...
Now that we've succeeded in a relatively simple problem, let's try something more complex. If you read the data documentation you'll find the definitions for the different skip categories
```{r,echo=FALSE}
...
```
With this accomplished let's go ahead and test our previous model but with listen_time as the predicted variable
...
```{r define sequences, include=FALSE}
