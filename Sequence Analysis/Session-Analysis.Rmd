...
skip_fit$model
```
State 4 seems to indicate non-skipping behavior while state 3 is associated with pressing the forward button. The transition probabilities show that a user who presses the forward button or listens to an entire song is likely to do the same thing for the next song. 
